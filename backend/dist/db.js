...
export async function listPublicAddresses(userId) {
    return getDb().select().from(publicAddresses).where(eq(publicAddresses.userId, userId));
}
export async function listFeaturePermissions(userId) {
